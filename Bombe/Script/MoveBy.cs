...
namespace Bombe {
	...
	public class MoveBy : IAction {

		/* ---------------------------------------------------------------------------------------- */
		      
		public MoveBy (float x, float y, float seconds, EaseFunction easingX = null, EaseFunction easingY = null, bool useLocal = false)
		{
			_useLocal = useLocal;
		...
		public MoveBy (Rigidbody2D body, float x, float y, float seconds, EaseFunction easingX = null, EaseFunction easingY = null)
		{
		...
		public MoveBy(Transform transform, float x, float y, float seconds, EaseFunction easingX = null, EaseFunction easingY = null, bool useLocal = false)
		{
			_useLocal = useLocal;
		...
		public float Update (float dt, GameObject actor)
		{
			if (_tweenX == null) {
				...
				_tweenX = new Tween(from.x, from.x + _x, _seconds, _easingX);
				_tweenY = new Tween(from.y, from.y + _y, _seconds, (_easingY != null) ? _easingY : _easingX);
			}
